...
export async function POST(request: NextRequest) {
  const logger = createAPILogger('/api/country-of-birth', generateRequestId());
  ...
  try {
    ...
    logger.error('Error fetching country of birth data', error instanceof Error ? error : new Error(String(error)));
