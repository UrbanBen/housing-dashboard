...
export async function POST(request: NextRequest) {
  const logger = createAPILogger('/api/dwelling-type', generateRequestId());
  ...
  try {
    ...
    logger.error('Error fetching dwelling type data', error instanceof Error ? error : new Error(String(error)));
