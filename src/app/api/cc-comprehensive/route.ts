...
export async function POST(request: NextRequest) {
  const logger = createAPILogger('/api/cc-comprehensive', generateRequestId());
  ...
  try {
    ...
    logger.error('[CC Comprehensive API] Error', error instanceof Error ? error : new Error(String(error)));
    return NextResponse.json(
      {
        success: false,
